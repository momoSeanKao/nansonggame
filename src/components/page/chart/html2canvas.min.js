    ...
    return function (A) {
        ...
        return t.m = A, t.c = e, t.d = function (A, e, r) {
            ...
            if (t.r(r), Object.defineProperty(r, "default", {
                enumerable: !0,
                value: A
            }), 2 & e && "string" != typeof A) for (var n in A) t.d(r, n, function (e) {
                return A[e]
            }.bind(null, n));
            return r
        }, t.n = function (A) {
        ...
        e.decode = function (A) {
            var e = .75 * A.length, t = A.length, r = void 0, B = 0, s = void 0, o = void 0, a = void 0, i = void 0;
        ...
        var r = function () {
            ...
            }(t(4)), o = t(1), a = e.LETTER_NUMBER_MODIFIER = 50, i = 10, c = 13, Q = 15, l = 17, w = 18, u = 19, U = 20,
            g = 21, F = 22, C = 24, h = 25, d = 26, H = 27, f = 28, E = 30, p = 32, K = 33, m = 34, b = 35, N = 37,
            y = 38, v = 39, I = 40, D = 42, M = (e.classes = {
                BK: 1,
                CR: 2,
                LF: 3,
                CM: 4,
                ...
                SA: D,
                XX: 43
            }, e.BREAK_MANDATORY = "!"), T = e.BREAK_NOT_ALLOWED = "×", S = e.BREAK_ALLOWED = "÷",
            X = e.UnicodeTrie = (0, B.createTrieFromBase64)(s.default), z = [E, 36], L = [1, 2, 3, 5], O = [i, 8],
            x = [H, d], V = L.concat(O), k = [y, v, I, m, b], J = [Q, c],
            R = e.codePointsToCharacterClasses = function (A) {
                ...
                if (n === i) for (var o = t; o > 0;) {
                    var a = r[--o];
                    if (Array.isArray(A) ? -1 !== A.indexOf(a) : A === a) for (var c = t; c <= r.length;) {
                        var Q = r[++c];
                        if (Q === e) return !0;
                        if (Q !== i) break
                    }
                ...
                var s = B - 1, o = B + 1, a = e[B], E = s >= 0 ? e[s] : 0, D = e[o];
                if (2 === a && 3 === D) return T;
                ...
                if (-1 !== [h, f, C, l, w].indexOf(D)) for (var V = B; V >= 0;) {
                    var R = e[V];
                    if (R === h) return T;
                    if (-1 === [f, C].indexOf(R)) break;
                    V--
                }
                if (-1 !== [H, d].indexOf(D)) for (var G = -1 !== [l, w].indexOf(a) ? s : B; G >= 0;) {
                    var W = e[G];
                    if (W === h) return T;
                ...
                var t = R(A), r = n(t, 2), B = r[0], s = r[1];
                return G(A, s, B, e)
            }, function (A, e) {
                e || (e = {lineBreak: "normal", wordBreak: "normal"});
                var t = R(A, e.lineBreak), r = n(t, 3), B = r[0], s = r[1], o = r[2];
                ...
                var t = (0, o.toCodePoints)(A), r = T, B = W(t, e), s = n(B, 3), a = s[0], i = s[1], c = s[2];
        ...
        e.LineBreaker = function (A, e) {
            var t = (0, o.toCodePoints)(A), r = W(t, e), B = n(r, 3), s = B[0], a = B[1], i = B[2], c = t.length, Q = 0,
                l = 0;
            return {
                next: function () {
        ...
        var r = function () {
            ...
            }(), n = t(1), B = e.UTRIE2_SHIFT_2 = 5, s = e.UTRIE2_SHIFT_1 = 11, o = e.UTRIE2_INDEX_SHIFT = 2,
            a = e.UTRIE2_SHIFT_1_2 = s - B, i = e.UTRIE2_LSCP_INDEX_2_OFFSET = 65536 >> B,
            c = e.UTRIE2_DATA_BLOCK_LENGTH = 1 << B, Q = e.UTRIE2_DATA_MASK = c - 1,
            l = e.UTRIE2_LSCP_INDEX_2_LENGTH = 1024 >> B, w = e.UTRIE2_INDEX_2_BMP_LENGTH = i + l,
            u = e.UTRIE2_UTF8_2B_INDEX_2_OFFSET = w, U = e.UTRIE2_UTF8_2B_INDEX_2_LENGTH = 32,
            g = e.UTRIE2_INDEX_1_OFFSET = u + U, F = e.UTRIE2_OMITTED_BMP_INDEX_1_LENGTH = 65536 >> s,
            C = e.UTRIE2_INDEX_2_BLOCK_LENGTH = 1 << a, h = e.UTRIE2_INDEX_2_MASK = C - 1,
        ...
        var B = /^#([a-f0-9]{3})$/i, s = function (A) {
        ...
        }, Q = /^rgba\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d?\.?\d+)\s*\)$/, l = function (A) {
            var e = A.match(Q);
            ...
            function A(e) {
                ...
                var t = function (A, e) {
                    ...
                    }(Array.isArray(e) ? w(e) : s(e) || c(e) || l(e) || u(e) || a(e) || [0, 0, 0, null], 4), r = t[0],
                    n = t[1], B = t[2], o = t[3];
        ...
        var H = function (A, e) {
            ...
            return function (A, e, t) {
                ...
                key: "renderRadialGradient", value: function (A, e) {
                    ...
                    if (B) if (H(e, B), this.ctx.fillStyle = B, e.radius.x !== e.radius.y) {
                        var s = A.left + .5 * A.width, o = A.top + .5 * A.height, a = e.radius.y / e.radius.x,
                            i = 1 / a;
        ...
        var y = {PX: 0, PERCENTAGE: 1}, v = function () {
            function A(e) {
                !function (A, e) {
                    if (!(A instanceof e)) throw new TypeError("Cannot call a class as a function")
        ...
        var S = function (A, e, t) {
            ...
            return function (A, e, t) {
                ...
                key: "subdivide", value: function (e, t) {
                    var r = S(this.start, this.startControl, e), n = S(this.startControl, this.endControl, e),
                        B = S(this.endControl, this.end, e), s = S(r, n, e), o = S(n, B, e), a = S(s, o, e);
        ...
        var L = function () {
            ...
            var r = t[R.TOP_LEFT][0].getAbsoluteValue(A.width), n = t[R.TOP_LEFT][1].getAbsoluteValue(A.height),
                B = t[R.TOP_RIGHT][0].getAbsoluteValue(A.width), s = t[R.TOP_RIGHT][1].getAbsoluteValue(A.height),
                o = t[R.BOTTOM_RIGHT][0].getAbsoluteValue(A.width), a = t[R.BOTTOM_RIGHT][1].getAbsoluteValue(A.height),
                i = t[R.BOTTOM_LEFT][0].getAbsoluteValue(A.width), c = t[R.BOTTOM_LEFT][1].getAbsoluteValue(A.height),
                Q = [];
            ...
            var w = A.width - B, u = A.height - a, U = A.width - o, g = A.height - c;
            return {
        ...
        }, R = {TOP_LEFT: 0, TOP_RIGHT: 1, BOTTOM_RIGHT: 2, BOTTOM_LEFT: 3}, _ = function (A, e, t, r, n) {
            var B = (Math.sqrt(2) - 1) / 3 * 4, s = t * B, o = r * B, a = A + t, i = e + r;
            switch (n) {
                case R.TOP_LEFT:
        ...
        }, P = ["top", "right", "bottom", "left"], G = function (A) {
            return P.map(function (e) {
                return new v(A.getPropertyValue("padding-".concat(e)))
            })
        }, W = {BORDER_BOX: 0, PADDING_BOX: 1, CONTENT_BOX: 2}, Y = W, q = function A(e) {
            switch (function (A, e) {
                if (!(A instanceof e)) throw new TypeError("Cannot call a class as a function")
            }(this, A), e) {
                case"contain":
        ...
        }, j = new q("auto"), Z = function (A, e, t, r) {
            var n = function (A, e) {
            ...
            switch (A) {
                case Y.BORDER_BOX:
                    return e;
                case Y.CONTENT_BOX:
                    var B = t[3].getAbsoluteValue(e.width), s = t[1].getAbsoluteValue(e.width),
                        o = t[0].getAbsoluteValue(e.width), a = t[2].getAbsoluteValue(e.width);
            ...
            return t.map(function (A, e) {
                var t = (B[e] || "auto").trim().split(" ").map(nA), s = (r[e] || "auto").trim().split(" ").map(BA);
                return {
                    source: A,
                    repeat: function (A) {
            ...
            var e = /^\s$/, t = [], r = [], n = "", B = null, s = "", o = 0, a = 0, i = function () {
                var A = "";
                if (n) {
            ...
            return oA.map(function (e) {
                var t = new U(A.getPropertyValue("border-".concat(e, "-color"))), r = function (A) {
                        switch (A) {
                            case"none":
                                return 0
                        }
        ...
        var iA = ["top-left", "top-right", "bottom-right", "bottom-left"], cA = function (A) {
            return iA.map(function (e) {
                ...
                }(A.getPropertyValue("border-".concat(e, "-radius")).split(" ").map(v.create), 2), r = t[0], n = t[1];
        ...
        }, HA = ["top", "right", "bottom", "left"], fA = function (A) {
            return HA.map(function (e) {
                return new v(A.getPropertyValue("margin-".concat(e)))
            })
        }, EA = {VISIBLE: 0, HIDDEN: 1, SCROLL: 2, AUTO: 3}, pA = function (A) {
            switch (A) {
                case"hidden":
                    return EA.HIDDEN;
                case"scroll":
        ...
        }, mA = {STATIC: 0, RELATIVE: 1, ABSOLUTE: 2, FIXED: 3, STICKY: 4}, bA = function (A) {
            switch (A) {
                case"relative":
                    return mA.RELATIVE;
                case"absolute":
        ...
        }, DA = /(matrix|matrix3d)\((.+)\)/, MA = function (A) {
        ...
        }, _A = RA, PA = t(0), GA = function A(e, t) {
            !function (A, e) {
                if (!(A instanceof e)) throw new TypeError("Cannot call a class as a function")
                ...
                key: "fromTextNode", value: function (e, t) {
                    ...
                    return new A(r, t, function (A, e, t) {
                        for (var r = 0 !== e.style.letterSpacing ? Object(PA.toCodePoints)(A).map(function (A) {
                            ...
                            var Q = r[c];
                            if (null !== e.style.textDecoration || Q.trim().length > 0) if (_A.SUPPORT_RANGE_BOUNDS) a.push(new GA(Q, YA(t, i, Q.length, s, o))); else {
        ...
        var ee = function A(e, t, n) {
            ...
            }, te = new U([42, 42, 42]), re = new U([165, 165, 165]), ne = new U([222, 222, 222]),
            Be = {borderWidth: 1, borderColor: re, borderStyle: 1}, se = [Be, Be, Be, Be], oe = {
                backgroundColor: ne,
                backgroundImage: [],
                backgroundClip: W.PADDING_BOX,
                backgroundOrigin: Y.PADDING_BOX
            }, ae = new v("50%"), ie = [ae, ae], ce = [ie, ie, ie, ie], Qe = new v("3px"), le = [Qe, Qe],
            we = [le, le, le, le], ue = function (A) {
                ...
                if (r) {
                    ...
                    var o = e.style.margin[0].getAbsoluteValue(e.bounds.width), a = r.listStyleImage;
                    if (a) if ("url" === a.method) {
        ...
        var Se = ["INPUT", "TEXTAREA", "SELECT"], Xe = function () {
            function A(e, t, r, n) {
                var B = this;
                !function (A, e) {
                    if (!(A instanceof e)) throw new TypeError("Cannot call a class as a function")
                ...
                var s = e.ownerDocument.defaultView, o = s.pageXOffset, a = s.pageYOffset,
                    i = s.getComputedStyle(e, null), c = wA(i.display), Q = "radio" === e.type || "checkbox" === e.type,
                    l = bA(i.position);
                if (this.style = {
        ...
        }(), xe = ["SCRIPT", "HEAD", "TITLE", "OBJECT", "BR", "OPTION"], Ve = function (A, e) {
        ...
        var We = /^(to )?(left|top|right|bottom)( (left|top|right|bottom))?$/i,
            ...
            $e = {
                ...
                for (var r = [], n = e; n < A.length; n++) {
                    var B = A[n], s = qe.test(B), o = B.lastIndexOf(" "), a = new U(s ? B.substring(0, o) : B),
                ...
                }), Q = c[0].stop, l = 0; l < c.length; l++) if (null !== Q) {
                    var w = c[l].stop;
                    if (null === w) {
                ...
                var r = function (A) {
                        ...
                        return null
                    }(A[0]), n = We.test(A[0]), B = n || null !== r || Ye.test(A[0]),
                ...
                var r = e[0].match(Ze), n = r && ("circle" === r[1] || void 0 !== r[3] && void 0 === r[5]) ? 0 : 1, B = {},
                    s = {};
                ...
                var t = e.width, r = e.height, n = .5 * t, B = .5 * r,
                    s = (Math.abs(t * Math.sin(A)) + Math.abs(r * Math.cos(A))) / 2, o = n + Math.sin(A) * s,
                    a = B - Math.cos(A) * s;
                ...
                }(A.split(" ").map(parseFloat), 2), r = t[0], n = t[1], B = r / 100 * e.width / (n / 100 * e.height);
                ...
                switch (A) {
                    case"closest-side":
                        ...
                        break;
                    case"closest-corner":
                        if (0 === e) o = a = Math.min(m(B, s), m(B, s - n.height), m(B - n.width, s), m(B - n.width, s - n.height)); else if (1 === e) {
                    ...
                    case"farthest-corner":
                        if (0 === e) o = a = Math.max(m(B, s), m(B, s - n.height), m(B - n.width, s), m(B - n.width, s - n.height)); else if (1 === e) {
                ...
                var e = "", t = "", r = "", n = "", B = 0,
                    ...
                    o = /^\d+(px|r?em|%)?(?:\s+\d+(px|r?em|%)?)?$/i, a = A[B].match(s);
                a && B++;
                ...
                var u = l || c;
                return u && (t = u[0], u[1] || (t += "px")), !n || e || t || r || (t = n, n = ""), n && (n = "at ".concat(n)), [[e, r, t, n].filter(function (A) {
                    return !!A
        ...
        var wt = function () {
            ...
            return function (A, e, t) {
                        ...
                        if (A.childNodes.length && A.childNodes.forEach(function (t) {
                            ...
                            if (t) {
                                var r = function (A, e, t) {
                                        var r = e[0].value, n = e[1].value, B = e[2].value, s = e[3].value;
                ...
                key: "renderBackgroundRepeat", value: function (A, e) {
                    ...
                    if (t) {
                        var r = Z(A.style.background.backgroundOrigin, A.bounds, A.style.padding, A.style.border),
                            ...
                            }(e, t, r), B = $(e.position, n, r), s = function (A, e, t, r, n) {
                                switch (A.repeat) {
                                    case 2:
                            ...
                            }(e, B, n, r, A.bounds), o = Math.round(r.left + B.x), a = Math.round(r.top + B.y);
                ...
                key: "renderStackContent", value: function (A) {
                    var e = Qt(Ut(A), 5), t = e[0], r = e[1], n = e[2], B = e[3], s = e[4], o = Qt(ut(A), 2), a = o[0],
                        i = o[1];
            ...
            return new Promise(function (r, n) {
                ...
                if (s.onload = function () {
                    if (s instanceof XMLHttpRequest) if (200 === s.status) if ("text" === B) r(s.response); else {
        ...
        var Ht = function () {
                    ...
                    key: "xhrImage", value: function (A) {
                        ...
                        return this.cache[A] = new Promise(function (t, r) {
                            ...
                            if (n.onreadystatechange = function () {
                                if (4 === n.readyState) if (200 !== n.status) r("Failed to fetch image ".concat(A.substring(0, 256), " with status code ").concat(n.status)); else {
            ...
            }(), Et = /^data:image\/svg\+xml/i, pt = /^data:image\/.*;base64,/i, Kt = /^data:image\/.*/i,
            mt = function (A) {
                return Kt.test(A)
            }, bt = function (A) {
                return pt.test(A)
        ...
        var Dt = function (A, e, t) {
            ...
            var r = Mt(e.content), n = r.length, B = [], s = "", o = e.counterIncrement;
            if (o && "none" !== o) {
                var a = It(o.split(/\s+/), 2), i = a[0], c = a[1], Q = t.counters[i];
        ...
        var Lt = function () {
                ...
                return function (A, e, t) {
                        ...
                        if (this.inlineImages && A) {
                            ...
                            Promise.all(sA(t.backgroundImage).map(function (A) {
                                ...
                                if (e && A instanceof HTMLImageElement && A.parentNode) {
                                    var t = A.parentNode, r = b(A.style, e.cloneNode(!1));
                                    t.replaceChild(r, A)
                                }
                            }).catch(function (A) {
                            })
                    ...
                    key: "createElementClone", value: function (A) {
                        ...
                        if (A instanceof HTMLIFrameElement) {
                            var r = A.cloneNode(!1), n = qt();
                            r.setAttribute("data-html2canvas-internal-iframe-key", n);
                            var B = O(A, 0, 0), s = B.width, o = B.height;
                    ...
                    key: "cloneNode", value: function (A) {
                        ...
                        for (var s = function (A, e) {
                            ...
                            for (var t = [], r = A.counterReset.split(/\s*,\s*/), n = r.length, B = 0; B < n; B++) {
                                var s = It(r[B].split(/\s+/), 2), o = s[0], a = s[1];
                                t.push(o);
                                var i = e.counters[o];
                ...
                return (A.cssRules ? Array.from(A.cssRules) : []).filter(function (A) {
                    ...
                    for (var t = sA(A.style.getPropertyValue("src")), r = [], n = 0; n < t.length; n++) if ("url" === t[n].method && t[n + 1] && "format" === t[n + 1].method) {
                ...
                if (t && t.content && "none" !== t.content && "-moz-alt-content" !== t.content && "none" !== t.display) {
                    ...
                    if (b(t, B), r) for (var s = r.length, o = 0; o < s; o++) {
                        var a = r[o];
                        switch (a.type) {
                            case 1:
            ...
            }, Jt = ":before", Rt = ":after", _t = "___html2canvas___pseudoelement_before",
            Pt = "___html2canvas___pseudoelement_after", Gt = function (A) {
        ...
        var er = function A(e, t, r) {
            var n = e.ownerDocument, B = new L(t.scrollX, t.scrollY, t.windowWidth, t.windowHeight),
            ...
            return (t.foreignObjectRendering ? _A.SUPPORT_FOREIGNOBJECT_DRAWING : Promise.resolve(!1)).then(function (s) {
                return s ? function (A) {
                    return A.inlineFonts(n).then(function () {
                        ...
                        var B = new xA(A.documentElement), s = n.defaultView, o = s.pageXOffset, i = s.pageYOffset,
                            c = "HTML" === e.tagName || "BODY" === e.tagName ? x(n) : O(e, o, i), Q = c.width,
                            l = c.height, w = c.left, u = c.top;
                        return B.render({
                            backgroundColor: a,
                            logger: r,
                            scale: t.scale,
                    ...
                    var s = new Lt(t, r, n, !1, B), o = A.defaultView.pageXOffset, a = A.defaultView.pageYOffset;
                    return $t(A, e).then(function (n) {
                        var B = n.contentWindow, i = B.document, c = Ar(n).then(function () {
                            ...
                            var t = Promise.resolve([n, s.clonedReferenceElement, s.resourceLoader]), o = r.onclone;
                        ...
                        }(document.doctype), "<html></html>")), function (A, e, t) {
                    ...
                    }(A, 3), B = e[0], s = e[1], o = e[2], i = function (A, e, t) {
                        var r = 0, n = new Xe(A, null, e, r++), B = new Oe(n, null, !0);
                        return function A(e, t, r, n, B) {
                            for (var s, o = e.firstChild; o; o = s) {
                                s = o.nextSibling;
                                var a = o.ownerDocument.defaultView;
                                if (o instanceof a.Text || o instanceof Text || a.parent && o instanceof a.parent.Text) o.data.trim().length > 0 && t.childNodes.push(jA.fromTextNode(o, t)); else if (o instanceof a.HTMLElement || o instanceof HTMLElement || a.parent && o instanceof a.parent.HTMLElement) {
                                    if (-1 === xe.indexOf(o.nodeName)) {
                                        ...
                                        if (i.isVisible()) {
                                            ...
                                            var c = "TEXTAREA" !== o.tagName, Q = Ve(i, o);
                                            if (Q || ke(i)) {
                    ...
                    return a === i.container.style.background.backgroundColor && (i.container.style.background.backgroundColor = F), o.ready().then(function (A) {
                        var e = new _e(c), o = c.defaultView, Q = o.pageXOffset, l = o.pageYOffset,
                            w = "HTML" === s.tagName || "BODY" === s.tagName ? x(n) : O(s, Q, l), u = w.width,
                            U = w.height, g = w.left, F = w.top, C = {
                                backgroundColor: a,
                                fontMetrics: e,
                                imageStore: A,
                                logger: r,
